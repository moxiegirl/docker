...
Currently the recommended way to connect containers is via the Docker network. You can see details of how to [work with links here](https://docs.docker.com/networking).
